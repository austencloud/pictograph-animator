<script lang="ts">
  ...
  function updatePropPositions() {
    ...
    bluePropState.x = centerX + Math.cos(bluePropState.centerPathAngle) * scaledHalfwayRadius;
    bluePropState.y = centerY + Math.sin(bluePropState.centerPathAngle) * scaledHalfwayRadius;
    
    // Update Red Prop position
    redPropState.x = centerX + Math.cos(redPropState.centerPathAngle) * scaledHalfwayRadius;
    redPropState.y = centerY + Math.sin(redPropState.centerPathAngle) * scaledHalfwayRadius;
  }
